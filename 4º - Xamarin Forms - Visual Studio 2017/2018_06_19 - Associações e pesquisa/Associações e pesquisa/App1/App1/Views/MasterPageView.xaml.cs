    ...
    public partial class MasterPageView : ContentPage
    {
        ...
        public MasterPageView()
        {
            ...
            OpcoesMenu = new[]{
                ...
                //new Models.MenuItem { Id = 0, Title = "Serviços", TargetType = typeof(ContentPage), IconSource="tab_servicos.png"}
                new Models.MenuItem { Id = 0, Title = "Serviços", TargetType = typeof(Servicos.ListagemView), IconSource="tab_servicos.png"},
                new Models.MenuItem{ Id = 2, Title = "Atendimentos", TargetType = typeof(Atendimentos.ListagemView), IconSource= "tab_atendimentos"}
            };
